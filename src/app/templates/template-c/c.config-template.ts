...
import { TEMPLATE_A_BUTTON_1_ID, TEMPLATE_A_BUTTON_2_ID } from './c.constants';
import { STYLE_TEMPLATE_C } from './c.style-template';

export const CONFIG_TEMPLATE_C: FormConfig = {
  fields: [
    {
      id: 'name',
      label: 'Name',
