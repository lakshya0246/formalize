...
import { TEMPLATE_A_BUTTON_1_ID, TEMPLATE_A_BUTTON_2_ID } from './b.constants';
import { STYLE_TEMPLATE_B } from './b.style-template';

export const CONFIG_TEMPLATE_B: FormConfig = {
  fields: [
    {
      id: 'name',
      label: 'Name',
